...
```bash
git clone https://github.com/ShridhiGupta/Flowtrack.git
cd Flowtrack
```
...
* Reduce distractions and increase accountability
...
* Track focused work hours
* Manage multiple projects

### Freelancers

* Monitor billable work time
